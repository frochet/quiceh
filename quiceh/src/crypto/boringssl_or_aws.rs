...
unsafe fn EVP_AEAD_CTX_seal_scatter(
    ...
    sys::EVP_AEAD_CTX_seal_scatter(
        ctx as _,
        out as _,
        out_tag as _,
        out_tag_len as _,
        max_out_tag_len as _,
        nonce as _,
        nonce_len as _,
        inp as _,
        in_len as _,
